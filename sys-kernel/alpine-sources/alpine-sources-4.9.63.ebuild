...
SRC_URI="${KERNEL_URI} https://dev.alpinelinux.org/~ncopa/grsec/hardened-3.1-${PV}-201704252333-alpine.patch -> alpine-patch-${PV}.tar.gz"

KEYWORDS="~amd64 ~x86"

src_prepare() {
	default
	eapply "${DISTDIR}"/alpine-patch-${PV}.tar.gz
}
pkg_postinst()
{
